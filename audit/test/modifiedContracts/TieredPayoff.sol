...
library TieredPayoff {
    ...
    event PayoffCalc(address indexed referrer, uint degree, uint tierPercentage, uint shares, uint reward);
        ...
        returns (uint)
    {
        ...
        if(degree == 1) {
            ...
            PayoffCalc(_referrer, degree, tierPercentage, shares, reward);
            return reward;
        }
